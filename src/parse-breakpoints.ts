import type { BreakpointDefinitions, BreakpointParseConfig } from "./types.js"
...
const parseBreakpoints = (
  ...
  return Object.entries(object).reduce<BreakpointDefinitions>((object_, [key, value]) => {
    ...
    if (breakpointMatch && typeof value === "string") {
      ...
      breakpoint[parseConfig.isMin(breakpointMatch[parseConfig.groupMinMax!]) ? "min" : "max"] =
        value
    }
